...
const CartaResponsabilidade = () => {
  ...
  async function handleDirectory(event: FormEvent) {
    ...
    const interval = setInterval(async () => {
      const result = await CartaResponsabilidadeService.chama()
      if (result.data) {
        setSaveLocation(result.data)
  ...
  async function handleSave(event: FormEvent) {
    ...
    try {
      const data = await CartaResponsabilidadeService.generate({
        startDate,
        endDate,
        homeSheet,
        descriptionPaging,
      ...
      Modal.success({
        content: 'Seus PDFs estão sendo gerados na na pasta: ' + saveLocation
      })
    } catch (error) {
      notification.error({
              ...
              <form>
                  ...
                  <Col span={5}>
                    <InputField>
                      ...
                      <DatePicker
                        ...
                        onChange={e => setStartDate(e?.toDate() || new Date())}
                        locale={locale}
                        format={'DD/MM/YYYY'}
                      />
                    </InputField>
                ...
                <Card title="Dados do Escritório" bordered={false}>
                  ...
                  <Row>
                    ...
                    <ButtonDirectory>
                      <button onClick={handleDirectory}> Escolher </button>
                    </ButtonDirectory>
                  </Row>
                </Card>
